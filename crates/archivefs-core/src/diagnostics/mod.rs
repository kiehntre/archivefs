...
pub const DEFERRED_CHECKS: &[DeferredCheck] = &[
    ...
    DeferredCheck {
        ...
        reason: "Managed entries are matched against ArchiveFS's install history, and PCSX2 .pnach files additionally carry an in-file ArchiveFS marker. Dolphin, Xenia and RetroArch files carry no marker, so an entry whose install record was deleted cannot be recognised - and ArchiveFS will not guess, because your own codes look identical.",
    },
    DeferredCheck {
